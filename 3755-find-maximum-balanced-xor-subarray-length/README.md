<h2><a href="https://leetcode.com/problems/find-maximum-balanced-xor-subarray-length">3755. Find Maximum Balanced XOR Subarray Length</a></h2><h3>Medium</h3><hr><p>Given an integer array <code>nums</code>, return the <strong>length</strong> of the <strong>longest subarray</strong> that has a bitwise XOR of zero and contains an <strong>equal</strong> number of <strong>even</strong> and <strong>odd</strong> numbers. If no such subarray exists, return 0.</p>
